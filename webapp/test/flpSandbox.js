		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "InvPrjct",
									"targetURL": "#efmgprjctinv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"efmgprjctinv-display": {
								"semanticObject": "efmgprjctinv",
								"action": "display",
								"description": "InvPrjct",
								"title": "InvPrjct",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=efmg.prjctinv",
									"url": sap.ui.require.toUrl("efmg/prjctinv")
								}
							}
						}
					}
